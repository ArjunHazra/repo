...
const SkillMatchingPage = () => {
    ...
    const fetchMatches = async () => {
      ...
      try {
        ...
        const ratingsPromises = response.data.map(async (match) => {
          ...
          const ratingResponse = await axios.get(`http://localhost:8000/api/sessions/ratings/${userId}`, {
            headers: { 'x-auth-token': token },
          });
  ...
  const sendSessionRequest = async (userId) => {
    ...
    try {
      await axios.post(
        'http://localhost:8000/api/sessions/request',
                  ...
                  <div
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <img
                        ...
                        src={match.user?.profilePicture ? `http://localhost:8000/uploads/profile-pictures/${match.user.profilePicture}` : '/default-avatar.png'}
                        alt="Avatar"
                      />
